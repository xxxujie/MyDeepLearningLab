...
class _TrainConfig(_BaseConfig):

    @property
    def learning_rate(self):
        return self._get_property("learning_rate")

    @property
    def weight_decay(self):
        return self._get_property("weight_decay")
...
train_config = _TrainConfig(_find_config_path("train_conf.yaml"))
